...
// If you need to close the dropdown on mouse leave, you can use JavaScript.
// This script closes the dropdown when the mouse leaves the dropdown area.
document.querySelectorAll('.dropdown-msg, .dropdown-noti, .profile-dropdown').forEach(function (dropdown) {
